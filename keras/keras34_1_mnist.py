...
model.add(Flatten()) # input_dim=25*25*64=40000
model.add(Dense(32, activation='relu'))  # 32- 임의, input shape (60000, 40000) -> (40000, )
...
# early stopping, modelcheck point, val_